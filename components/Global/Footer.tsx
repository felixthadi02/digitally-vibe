...
//   return (
//     <footer ref={footerRef} className="relative bg-gray-900 pt-20 overflow-hidden">
//       {/* Animated Wave */}
...
//               <div className="w-10 h-10 bg-[#ff3233]/20 rounded-xl flex items-center justify-center">
//                 <span className="text-[#ff3233]">📧</span>
//               </div>
//               <div>
//                 <div className="text-gray-500 text-xs">Email Us</div>
//                 <a href="mailto:hello@digitallyvibe.com" className="text-white hover:text-[#ff3233] transition-colors">
...
//                 <a href="tel:+1234567890" className="text-white hover:text-[#ff3233] transition-colors">
//                   +1 (234) 567-890
//                 </a>
//               </div>
//             </div>
